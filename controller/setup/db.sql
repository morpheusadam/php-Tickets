...
INSERT INTO `countries` (`c_id`, `country_code`, `country_name`) VALUES
(1, 'IR', 'جمهوری اسلامی ایران'),
(2, 'CA', 'Canada'),
(3, 'AF', 'Afghanistan'),
(4, 'AL', 'Albania'),
(5, 'DZ', 'Algeria'),
...
(99, 'IN', 'India'),
(100, 'ID', 'Indonesia'),
(101, 'US', 'United state of America'),
(102, 'IQ', 'Iraq'),
(103, 'IE', 'Ireland'),
(104, 'IL', 'Israel'),
(105, 'IT', 'Italy'),
...
--
-- Table structure for table `stuff_relations`
--

CREATE TABLE IF NOT EXISTS `stuff_relations` (
  `r_id` int(11) NOT NULL AUTO_INCREMENT,
  `stuff_id` bigint(20) NOT NULL,
  `stuff_departments` varchar(100) NOT NULL,
  `edit_customers` int(11) NOT NULL,
  PRIMARY KEY (`r_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `active_key` varchar(250) NOT NULL,
